    ...
    <section class="pt-0 poster-section">
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                <h4>À Venda <span class="theme-color">35% Off</span></h4>
                <h1>ùltimas Ofertas de <span>Vestidos</span></h1>
                <p>COMPRE UM E LEVE OUTRO DE <span class="theme-color">GRAÇA!</span></p>
                <h2>R$79.00 <span class="theme-color"><del>R$65.00</del></span></h2>
            ...
            <div class="row gy-4">
                    ...
                    <div class="collection-banner p-bottom p-center text-center">
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">Novos Moletons</h2>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="collection-banner p-bottom p-center text-center">
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">Moda Feminina</h2>
                                <span>Nova Oferta 50% off</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="collection-banner p-bottom p-center text-center">
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">Novas Jaquetas</h2>
                                <span>BUY ONE GET ONE FREE</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title title-2 text-center">
                        <h2>Nossa Categoria</h2>
                        <h5 class="text-color">Nossa Coleção</h5>
                    </div>
                </div>
            </div>
            <div class="row gy-3">
                <div class="col-xxl-2 col-lg-3">
                    <div class="category-wrap category-padding category-block theme-bg-color">
                        <div>
                            ...
                            <h2 class="top-spacing">Nossa  Top</h2>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                ...
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Sapatos</h3>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="assets/images/fashion/category/2.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Homens</h3>
                                    <span class="text-dark">Fashion</span>
                                </div>
                            </a>
                        </div>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="assets/images/fashion/category/4.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Jaquetas</h3>
                                    <span class="text-dark">Fashion</span>
                                </div>
                            </a>
                        </div>
